...
$InstallArgs = @{
   ...
   url            = 'https://downloads.ccdc.cam.ac.uk/Mercury/3.10.3/mercurystandalone-3.10.3-windows-installer.exe'
   checksumType   = 'sha256'
   checksum       = '5c245389ea3284f7b153437d36b4493f15ab92f08fdc2ae8d97f3367156512cb'
