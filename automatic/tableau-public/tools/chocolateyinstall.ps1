...
$packageArgs = @{
   ...
   fileType      = 'EXE'
   url64bit      = 'https://downloads.tableau.com/public/TableauPublicDesktop-64bit-2026-1-0.exe'
   checksum64    = 'a9c26df384011998398d69b77a3c6d62be9a67bb702bd2c024d2d7bdfa032630'
   checksumType  = 'sha256'
