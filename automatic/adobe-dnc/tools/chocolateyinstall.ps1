...
$packageArgs = @{
   ...
   fileType       = 'EXE'
   url64bit       = 'https://download.adobe.com/pub/adobe/dng/win/AdobeDNGConverter_x64_18_1_1.exe'
   checksum64     = '65aefeb897c13d6702362bd6bbe9ae8eaa65fcd2bf37f67fd1b9bab84219c6fb'
