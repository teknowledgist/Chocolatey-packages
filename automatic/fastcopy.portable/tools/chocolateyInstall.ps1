...
$packageArgs = @{
   ...
   fileType      = 'EXE'
   url           = 'https://raw.githubusercontent.com/FastCopyLab/FastCopyDist2/main/FastCopy5.5.0_installer.exe'
   checksum      = '87444aa9806990220dd5767e61af11b69db0e9a8121a616b9f5670a508603aa9'
   checksumType  = 'sha256'
