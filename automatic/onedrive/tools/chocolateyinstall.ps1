...
$packageArgs = @{
   ...
   fileType      = 'exe'
   url           = 'https://oneclient.sfx.ms/Win/Installers/23.204.1001.0003/amd64/OneDriveSetup.exe'
   checksum      = 'febf5544fa91a8e74574dbc6cdafdb462fe64592bcc8806d9ec207647a970c55'
   checksumType  = 'sha256'
