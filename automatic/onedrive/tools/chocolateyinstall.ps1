...
$packageArgs = @{
   ...
   fileType      = 'exe'
   url           = 'https://oneclient.sfx.ms/Win/Installers/23.214.1015.0001/amd64/OneDriveSetup.exe'
   checksum      = 'f580f8c17f1b8f7ede556a6c8060b8b6b84862b380eb43f2ad3e91d048a3f7b9'
   checksumType  = 'sha256'
