...
$packageName = 'qcad'
$url32 = 'https://www.qcad.orghttps://www.qcad.org/archives/qcad/qcad-3.32.9-trial-win32-installer.msi'
$url64 = 'https://www.qcad.orghttps://www.qcad.org/archives/qcad/qcadcam-3.32.9-trial-win32-installer.msi'
$checkSum32 = ''
$checkSum64 = ''
