...
$InstallArgs = @{
   ...
   fileType      = 'MSI' 
   url           = 'https://download.pdf24.org/pdf24-creator-11.18.0-x86.msi'
   checksum      = 'A8E996B7813A12FA5B00E6A0424B7AB006A763153D3B91F9C39F27E5ADB62B69'
   url64bit      = 'https://download.pdf24.org/pdf24-creator-11.18.0-x64.msi'
   checksum64    = '080D31F8F30021643A1D8EF57F8D7169763363B472CE5A95FADA3A5D1039055F'
