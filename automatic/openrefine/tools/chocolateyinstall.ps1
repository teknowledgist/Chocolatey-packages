...
$WebFileArgs = @{
   ...
   Url          = 'https://github.com/OpenRefine/OpenRefine/releases/download/3.7.3/openrefine-win-with-java-3.7.3.zip'
   Checksum     = '1ca577e3c46990a6f15f15ed424347a07308a622030ab407730b74d8e49c4fbf'
   ChecksumType = 'sha256'
