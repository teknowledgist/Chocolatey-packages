...
$WebFileArgs = @{
   ...
   Url          = 'https://github.com/OpenRefine/OpenRefine/releases/download/3.7.4/openrefine-win-with-java-3.7.4.zip'
   Checksum     = '8f00e1eae44f97647ab6ca725b694f7a1cd41458555596c177dc156fedfa6dd2'
   ChecksumType = 'sha256'
