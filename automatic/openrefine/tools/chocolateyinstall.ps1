...
$WebFileArgs = @{
   ...
   Url          = 'https://github.com/OpenRefine/OpenRefine/releases/download/3.8.0/openrefine-win-with-java-3.8.0.zip'
   Checksum     = '7d0ecfdee26306a6f4bff978481d86c46337a065c65b780bfcd37480eb1d90db'
   ChecksumType = 'sha256'
