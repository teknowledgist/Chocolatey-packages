...
$WebFileArgs = @{
   ...
   Url          = 'https://github.com/OpenRefine/OpenRefine/releases/download/3.9.1/openrefine-win-with-java-3.9.1.zip'
   Checksum     = '154c36a58658abad59d8ee2b5b241753d788df8701183871fc1d9601e067bae3'
   ChecksumType = 'sha256'
