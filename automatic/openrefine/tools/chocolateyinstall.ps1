...
$WebFileArgs = @{
   ...
   Url          = 'https://github.com/OpenRefine/OpenRefine/releases/download/3.7.5/openrefine-win-with-java-3.7.5.zip'
   Checksum     = '90ae7f3115d6340262b9725df817b1099fe97f5c1127bd16df0e0a2f0993105a'
   ChecksumType = 'sha256'
