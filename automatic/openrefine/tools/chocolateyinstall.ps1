...
$WebFileArgs = @{
   ...
   Url          = 'https://github.com/OpenRefine/OpenRefine/releases/download/3.8.2/openrefine-win-with-java-3.8.2.zip'
   Checksum     = '2f702e53306395494df4ad9419ae01e26f61c3fb6f31bfc14d011c277587ad11'
   ChecksumType = 'sha256'
