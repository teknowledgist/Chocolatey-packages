...
$WebFileArgs = @{
   ...
   Url          = 'https://github.com/OpenRefine/OpenRefine/releases/download/3.7.9/openrefine-win-with-java-3.7.9.zip'
   Checksum     = '10913a1371c7a687b2cc2e2f22c76d99f028e25fbc2ce40efdd754eff2b2f680'
   ChecksumType = 'sha256'
