...
$InstallArgs = @{
   ...
   fileType      = 'EXE'
   url64bit      = 'https://repo.anaconda.com/archive/Anaconda3-2023.03-Windows-x86_64.exe'
   checksum64    = '849daee6c1926bb43306d0e4ce0cc50719b5bb5e43e085fc5092513ef8bf1fd5'
   checksumType  = 'sha256'
   validExitCodes= @(0)
}
