...
$InstallArgs = @{
   ...
   fileType      = 'EXE'
   url64bit      = 'https://repo.anaconda.com/archive/Anaconda3-2024.02-1-Windows-x86_64.exe'
   checksum64    = '087c633e355bc709222ad9e0dbad77abeed84f7e06dbdbecae84ba8b3660429e'
   checksumType  = 'sha256'
   validExitCodes= @(0)
}
